...
public class TailModel extends BipedEntityModel<AbstractClientPlayerEntity> {
	...
	public static ModelPart getModel(boolean isSneaking) {
		...
		ModelPartData tail = origin.addChild("tail", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		tail.addChild("t1", ModelPartBuilder.create().uv(2, 0).cuboid(-2.0F, -0.621F, 0.15F, 4.0F, 2.25F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		tail.addChild("t4", ModelPartBuilder.create().uv(-3, 8).cuboid(-2.75F, 2.704F, 0.675F, 5.5F, 3.55F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		tail.addChild("t8", ModelPartBuilder.create().uv(1, 19).cuboid(-2.5F, 6.233F, 5.353F, 5.0F, 4.25F, 2.5F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData fins = origin.addChild("fins", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 14.0F, -2.0F));
