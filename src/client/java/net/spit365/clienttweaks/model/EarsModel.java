...
public class EarsModel extends BipedEntityModel<AbstractClientPlayerEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
        	ModelPartData ears = modelData.getRoot().addChild("ears", ModelPartBuilder.create(), ModelTransform.pivot(0f, 0f, 0f));
